...
/// struct for typed errors of method [`mempool_addresses_address_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MempoolAddressesAddressGetError {
...
/// struct for typed errors of method [`mempool_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MempoolGetError {
    Status400(models::Get400Response),
    Status403(models::Get403Response),
    Status404(models::BlocksLatestGet404Response),
    Status418(models::Get418Response),
...
/// struct for typed errors of method [`mempool_hash_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MempoolHashGetError {
    Status400(models::Get400Response),
    Status403(models::Get403Response),
    Status404(models::BlocksLatestGet404Response),
    Status418(models::Get418Response),
...
pub async fn mempool_addresses_address_get(configuration: &configuration::Configuration, address: &str, count: Option<i32>, page: Option<i32>, order: Option<&str>) -> Result<Vec<models::MempoolContentInner>, Error<MempoolAddressesAddressGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/mempool/addresses/{address}", local_var_configuration.base_path, address=crate::apis::urlencode(address));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MempoolAddressesAddressGetError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn mempool_get(configuration: &configuration::Configuration, count: Option<i32>, page: Option<i32>, order: Option<&str>) -> Result<Vec<models::MempoolContentInner>, Error<MempoolGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MempoolGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn mempool_hash_get(configuration: &configuration::Configuration, hash: &str) -> Result<models::MempoolTxContent, Error<MempoolHashGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/mempool/{hash}", local_var_configuration.base_path, hash=crate::apis::urlencode(hash));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MempoolHashGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
