...
/// struct for typed errors of method [`metadata_txs_labels_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MetadataTxsLabelsGetError {
...
/// struct for typed errors of method [`metadata_txs_labels_label_cbor_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MetadataTxsLabelsLabelCborGetError {
    Status400(models::Get400Response),
    Status403(models::Get403Response),
    Status404(models::BlocksLatestGet404Response),
    Status418(models::Get418Response),
...
/// struct for typed errors of method [`metadata_txs_labels_label_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MetadataTxsLabelsLabelGetError {
    Status400(models::Get400Response),
    Status403(models::Get403Response),
    Status404(models::BlocksLatestGet404Response),
    Status418(models::Get418Response),
...
pub async fn metadata_txs_labels_get(configuration: &configuration::Configuration, count: Option<i32>, page: Option<i32>, order: Option<&str>) -> Result<Vec<models::TxMetadataLabelsInner>, Error<MetadataTxsLabelsGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/metadata/txs/labels", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MetadataTxsLabelsGetError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn metadata_txs_labels_label_cbor_get(configuration: &configuration::Configuration, label: &str, count: Option<i32>, page: Option<i32>, order: Option<&str>) -> Result<Vec<models::TxMetadataLabelCborInner>, Error<MetadataTxsLabelsLabelCborGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/metadata/txs/labels/{label}/cbor", local_var_configuration.base_path, label=crate::apis::urlencode(label));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MetadataTxsLabelsLabelCborGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
/// Transaction metadata per label.
pub async fn metadata_txs_labels_label_get(configuration: &configuration::Configuration, label: &str, count: Option<i32>, page: Option<i32>, order: Option<&str>) -> Result<Vec<models::TxMetadataLabelJsonInner>, Error<MetadataTxsLabelsLabelGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/metadata/txs/labels/{label}", local_var_configuration.base_path, label=crate::apis::urlencode(label));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MetadataTxsLabelsLabelGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
