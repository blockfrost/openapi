...
/// struct for typed errors of method [`utils_addresses_xpub_xpub_role_index_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UtilsAddressesXpubXpubRoleIndexGetError {
...
/// struct for typed errors of method [`utils_txs_evaluate_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UtilsTxsEvaluatePostError {
    Status400(models::Get400Response),
    Status403(models::Get403Response),
    Status404(models::BlocksLatestGet404Response),
    Status418(models::Get418Response),
...
/// struct for typed errors of method [`utils_txs_evaluate_utxos_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UtilsTxsEvaluateUtxosPostError {
    Status400(models::Get400Response),
    Status403(models::Get403Response),
    Status404(models::BlocksLatestGet404Response),
    Status418(models::Get418Response),
...
pub async fn utils_addresses_xpub_xpub_role_index_get(configuration: &configuration::Configuration, xpub: &str, role: i32, index: i32) -> Result<models::UtilsAddressesXpub, Error<UtilsAddressesXpubXpubRoleIndexGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/utils/addresses/xpub/{xpub}/{role}/{index}", local_var_configuration.base_path, xpub=crate::apis::urlencode(xpub), role=role, index=index);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UtilsAddressesXpubXpubRoleIndexGetError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn utils_txs_evaluate_post(configuration: &configuration::Configuration, content_type: &str, body: &str) -> Result<std::collections::HashMap<String, serde_json::Value>, Error<UtilsTxsEvaluatePostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/utils/txs/evaluate", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UtilsTxsEvaluatePostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn utils_txs_evaluate_utxos_post(configuration: &configuration::Configuration, content_type: &str, utils_txs_evaluate_utxos_post_request: models::UtilsTxsEvaluateUtxosPostRequest) -> Result<std::collections::HashMap<String, serde_json::Value>, Error<UtilsTxsEvaluateUtxosPostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/utils/txs/evaluate/utxos", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&utils_txs_evaluate_utxos_post_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UtilsTxsEvaluateUtxosPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
