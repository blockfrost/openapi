...
/// struct for typed errors of method [`ipfs_pin_add_ipfs_path_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum IpfsPinAddIpfsPathPostError {
    ...
    Status425(models::IpfsPinAddIpfsPathPost425Response),
    Status429(models::Get429Response),
    Status500(models::Get500Response),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`ipfs_pin_list_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum IpfsPinListGetError {
    Status400(models::Get400Response),
    Status403(models::Get403Response),
    Status404(models::BlocksLatestGet404Response),
    Status418(models::Get418Response),
...
/// struct for typed errors of method [`ipfs_pin_list_ipfs_path_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum IpfsPinListIpfsPathGetError {
    Status400(models::Get400Response),
    Status403(models::Get403Response),
    Status404(models::BlocksLatestGet404Response),
    Status418(models::Get418Response),
...
/// struct for typed errors of method [`ipfs_pin_remove_ipfs_path_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum IpfsPinRemoveIpfsPathPostError {
    Status400(models::Get400Response),
    Status403(models::Get403Response),
    Status404(models::BlocksLatestGet404Response),
    Status418(models::Get418Response),
...
pub async fn ipfs_pin_add_ipfs_path_post(configuration: &configuration::Configuration, ipfs_path: &str) -> Result<models::IpfsPinAddIpfsPathPost200Response, Error<IpfsPinAddIpfsPathPostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/ipfs/pin/add/{IPFS_path}", local_var_configuration.base_path, IPFS_path=crate::apis::urlencode(ipfs_path));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<IpfsPinAddIpfsPathPostError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn ipfs_pin_list_get(configuration: &configuration::Configuration, count: Option<i32>, page: Option<i32>, order: Option<&str>) -> Result<Vec<models::IpfsPinListGet200ResponseInner>, Error<IpfsPinListGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/ipfs/pin/list", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<IpfsPinListGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn ipfs_pin_list_ipfs_path_get(configuration: &configuration::Configuration, ipfs_path: &str) -> Result<models::IpfsPinListIpfsPathGet200Response, Error<IpfsPinListIpfsPathGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/ipfs/pin/list/{IPFS_path}", local_var_configuration.base_path, IPFS_path=crate::apis::urlencode(ipfs_path));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<IpfsPinListIpfsPathGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

/// Remove pinned objects from local storage  <p>   <span class=\"hosted\">Hosted</span> Endpoint only available for hosted variant. </p> 
pub async fn ipfs_pin_remove_ipfs_path_post(configuration: &configuration::Configuration, ipfs_path: &str) -> Result<models::IpfsPinRemoveIpfsPathPost200Response, Error<IpfsPinRemoveIpfsPathPostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/ipfs/pin/remove/{IPFS_path}", local_var_configuration.base_path, IPFS_path=crate::apis::urlencode(ipfs_path));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<IpfsPinRemoveIpfsPathPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
