...
/// struct for typed errors of method [`nutlink_address_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NutlinkAddressGetError {
...
/// struct for typed errors of method [`nutlink_address_tickers_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NutlinkAddressTickersGetError {
    Status400(models::Get400Response),
    Status403(models::Get403Response),
    Status404(models::BlocksLatestGet404Response),
    Status418(models::Get418Response),
...
/// struct for typed errors of method [`nutlink_address_tickers_ticker_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NutlinkAddressTickersTickerGetError {
    Status400(models::Get400Response),
    Status403(models::Get403Response),
    Status404(models::BlocksLatestGet404Response),
    Status418(models::Get418Response),
...
/// struct for typed errors of method [`nutlink_tickers_ticker_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum NutlinkTickersTickerGetError {
    Status400(models::Get400Response),
    Status403(models::Get403Response),
    Status404(models::BlocksLatestGet404Response),
    Status418(models::Get418Response),
...
pub async fn nutlink_address_get(configuration: &configuration::Configuration, address: &str) -> Result<models::NutlinkAddress, Error<NutlinkAddressGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/nutlink/{address}", local_var_configuration.base_path, address=crate::apis::urlencode(address));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NutlinkAddressGetError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn nutlink_address_tickers_get(configuration: &configuration::Configuration, address: &str, count: Option<i32>, page: Option<i32>, order: Option<&str>) -> Result<Vec<models::NutlinkAddressTickersInner>, Error<NutlinkAddressTickersGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/nutlink/{address}/tickers", local_var_configuration.base_path, address=crate::apis::urlencode(address));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NutlinkAddressTickersGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn nutlink_address_tickers_ticker_get(configuration: &configuration::Configuration, address: &str, ticker: &str, count: Option<i32>, page: Option<i32>, order: Option<&str>) -> Result<Vec<models::NutlinkAddressTickerInner>, Error<NutlinkAddressTickersTickerGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/nutlink/{address}/tickers/{ticker}", local_var_configuration.base_path, address=crate::apis::urlencode(address), ticker=crate::apis::urlencode(ticker));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NutlinkAddressTickersTickerGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
/// List of records of a specific ticker
pub async fn nutlink_tickers_ticker_get(configuration: &configuration::Configuration, ticker: &str, count: Option<i32>, page: Option<i32>, order: Option<&str>) -> Result<Vec<models::NutlinkTickersTickerInner>, Error<NutlinkTickersTickerGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/nutlink/tickers/{ticker}", local_var_configuration.base_path, ticker=crate::apis::urlencode(ticker));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<NutlinkTickersTickerGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
