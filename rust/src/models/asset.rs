...
impl Asset {
    pub fn new(
        ...
        mint_or_burn_count: i32,
        onchain_metadata: Option<::std::collections::HashMap<String, serde_json::Value>>,
        ...
        Asset {
            ...
            metadata: if let Some(x) = metadata {
                Some(Box::new(x))
            } else {
                None
            },
