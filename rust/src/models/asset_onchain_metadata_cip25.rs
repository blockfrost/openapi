...
use super::{
    asset_onchain_metadata_cip25_description::AssetOnchainMetadataCip25Description,
    asset_onchain_metadata_cip25_files_inner::AssetOnchainMetadataCip25FilesInner,
    asset_onchain_metadata_cip25_image::AssetOnchainMetadataCip25Image,
};
...
pub struct AssetOnchainMetadataCip25 {
    ...
    pub name: String,
    #[serde(rename = "image")]
    pub image: Box<AssetOnchainMetadataCip25Image>,
    #[serde(rename = "description", skip_serializing_if = "Option::is_none")]
    pub description: Option<Box<AssetOnchainMetadataCip25Description>>,
    /// Mime sub-type of image
    #[serde(rename = "mediaType", skip_serializing_if = "Option::is_none")]
    pub media_type: Option<String>,
    #[serde(rename = "files", skip_serializing_if = "Option::is_none")]
    pub files: Option<Vec<AssetOnchainMetadataCip25FilesInner>>,
}
...
impl AssetOnchainMetadataCip25 {
    ...
    pub fn new(name: String, image: AssetOnchainMetadataCip25Image) -> AssetOnchainMetadataCip25 {
