...
pub struct CardanoTransactionSnapshotListMessageInner {
...
impl CardanoTransactionSnapshotListMessageInner {
    pub fn new(hash: String, certificate_hash: String, merkle_root: String, epoch: i64, block_number: i64, created_at: String) -> CardanoTransactionSnapshotListMessageInner {
