...
use super::{
    cardano_db_beacon::CardanoDbBeacon,
    certificate_list_item_message_metadata::CertificateListItemMessageMetadata,
...
impl CertificateListItemMessage {
    ...
    pub fn new(
        ...
        epoch: i64,
        signed_entity_type: std::collections::HashMap<String, serde_json::Value>,
