...
pub struct EpochParamContent {
    ...
    #[serde(rename = "nonce")]
    pub nonce: String,
    /// Cost models parameters for Plutus Core scripts. Deprecated, use `cost_models_raw` instead.
    ...
    #[serde(rename = "cost_models_raw", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
