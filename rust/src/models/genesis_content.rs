...
pub struct GenesisContent {
    ...
    pub active_slots_coefficient: f32,
...
impl GenesisContent {
    pub fn new(active_slots_coefficient: f32, update_quorum: i32, max_lovelace_supply: String, network_magic: i32, epoch_length: i32, system_start: i32, slots_per_kes_period: i32, slot_length: i32, max_kes_evolutions: i32, security_param: i32) -> GenesisContent {
        GenesisContent {
