...
use super::{
    mempool_tx_content_inputs_inner::MempoolTxContentInputsInner,
    mempool_tx_content_outputs_inner::MempoolTxContentOutputsInner,
    mempool_tx_content_redeemers_inner::MempoolTxContentRedeemersInner,
    mempool_tx_content_tx::MempoolTxContentTx,
};

#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MempoolTxContent {
    #[serde(rename = "tx")]
    pub tx: Box<MempoolTxContentTx>,
    #[serde(rename = "inputs")]
    pub inputs: Vec<MempoolTxContentInputsInner>,
    #[serde(rename = "outputs")]
    pub outputs: Vec<MempoolTxContentOutputsInner>,
    #[serde(rename = "redeemers", skip_serializing_if = "Option::is_none")]
    pub redeemers: Option<Vec<MempoolTxContentRedeemersInner>>,
}

impl MempoolTxContent {
    pub fn new(
        tx: MempoolTxContentTx,
        inputs: Vec<MempoolTxContentInputsInner>,
        outputs: Vec<MempoolTxContentOutputsInner>,
    ) -> MempoolTxContent {
        MempoolTxContent {
            tx: Box::new(tx),
            inputs,
