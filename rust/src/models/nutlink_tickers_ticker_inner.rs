...
pub struct NutlinkTickersTickerInner {
    ...
    pub payload: Box<crate::models::NutlinkAddressTickerInnerPayload>,
}

impl NutlinkTickersTickerInner {
    pub fn new(address: String, tx_hash: String, block_height: i32, tx_index: i32, payload: crate::models::NutlinkAddressTickerInnerPayload) -> NutlinkTickersTickerInner {
