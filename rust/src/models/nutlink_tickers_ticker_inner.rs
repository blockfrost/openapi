...
use super::nutlink_address_ticker_inner_payload::NutlinkAddressTickerInnerPayload;
...
pub struct NutlinkTickersTickerInner {
    ...
    pub payload: Box<NutlinkAddressTickerInnerPayload>,
}
...
impl NutlinkTickersTickerInner {
    pub fn new(
        ...
        block_height: i32,
        tx_index: i32,
        payload: NutlinkAddressTickerInnerPayload,
