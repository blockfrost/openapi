...
impl Pool {
    pub fn new(pool_id: String, hex: String, vrf_key: String, blocks_minted: i32, blocks_epoch: i32, live_stake: String, live_size: f32, live_saturation: f32, live_delegators: f32, active_stake: String, active_size: f32, declared_pledge: String, live_pledge: String, margin_cost: f32, fixed_cost: String, reward_account: String, owners: Vec<String>, registration: Vec<String>, retirement: Vec<String>) -> Pool {
        Pool {
            pool_id,
            hex,
            vrf_key,
