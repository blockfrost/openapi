...
pub struct PoolMetadata {
    ...
    pub error: Option<Box<models::ProposalMetadataV2Error>>,
...
impl PoolMetadata {
    pub fn new(pool_id: String, hex: String, url: Option<String>, hash: Option<String>, ticker: Option<String>, name: Option<String>, description: Option<String>, homepage: Option<String>) -> PoolMetadata {
        PoolMetadata {
            pool_id,
            hex,
            url,
