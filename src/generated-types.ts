...
export interface paths {
  ...
  "/mithril/epoch-settings": {
     ...
     * @description Returns the information related to the current epoch:
    ...
    get: {
      responses: {
        ...
        200: {
          content: {
            "application/json": components["schemas"]["EpochSettingsMessage"];
          };
        };
        /** @description API version mismatch */
        412: {
  ...
  "/mithril/certificate-pending": {
    ...
    get: {
      responses: {
        ...
        200: {
          content: {
            "application/json": components["schemas"]["CertificatePendingMessage"];
          };
        };
  ...
  "/mithril/certificates": {
    ...
    get: {
      responses: {
        ...
        200: {
          content: {
            "application/json": components["schemas"]["CertificateListMessage"];
          };
        };
        /** @description API version mismatch */
        412: {
  ...
  "/mithril/certificate/{certificate_hash}": {
    ...
    get: {
      ...
      responses: {
        ...
        200: {
          content: {
            "application/json": components["schemas"]["CertificateMessage"];
          };
        };
  ...
  "/mithril/artifact/snapshots": {
    ...
    get: {
      responses: {
        ...
        200: {
          content: {
            "application/json": components["schemas"]["SnapshotListMessage"];
          };
        };
        /** @description API version mismatch */
        412: {
  ...
  "/mithril/artifact/snapshot/{digest}": {
     ...
     * @description Returns the information of a snapshot and where to retrieve its binary content
     */
    get: {
      parameters: {
        path: {
      ...
      responses: {
        ...
        200: {
          content: {
            "application/json": components["schemas"]["SnapshotMessage"];
          };
        };
  ...
  "/mithril/artifact/snapshot/{digest}/download": {
     ...
     * @description Returns the snapshot archive binary content
     */
    get: {
      parameters: {
        path: {
  ...
  "/mithril/artifact/mithril-stake-distributions": {
    ...
    get: {
      responses: {
        ...
        200: {
          content: {
            "application/json": components["schemas"]["MithrilStakeDistributionListMessage"];
          };
        };
        /** @description API version mismatch */
        412: {
  ...
  "/mithril/artifact/mithril-stake-distribution/{hash}": {
    ...
    get: {
      ...
      responses: {
        ...
        200: {
          content: {
            "application/json": components["schemas"]["MithrilStakeDistributionMessage"];
          };
        };
  ...
  "/mithril/artifact/cardano-transactions": {
     ...
     * @description Returns the list of the most recent Cardano transactions set snapshots
     */
    get: {
      responses: {
        ...
        200: {
          content: {
            "application/json": components["schemas"]["CardanoTransactionSnapshotListMessage"];
          };
        };
        /** @description API version mismatch */
        412: {
  ...
  "/mithril/artifact/cardano-transaction/{hash}": {
     ...
     * @description Returns the information of a Cardano transactions set snapshot
     */
    get: {
      parameters: {
        path: {
      ...
      responses: {
        ...
        200: {
          content: {
            "application/json": components["schemas"]["CardanoTransactionSnapshotMessage"];
          };
        };
  ...
  "/mithril/proof/cardano-transaction": {
    ...
    get: {
      ...
      responses: {
        ...
        200: {
          content: {
            "application/json": components["schemas"]["CardanoTransactionProofMessage"];
          };
        };
  ...
  "/mithril/signers/registered/{epoch}": {
    ...
    get: {
      ...
      responses: {
        ...
        200: {
          content: {
            "application/json": components["schemas"]["SignerRegistrationsMessage"];
          };
        };
  ...
  "/mithril/signers/tickers": {
    ...
    get: {
      responses: {
        ...
        200: {
          content: {
            "application/json": components["schemas"]["SignersTickersMessage"];
          };
        };
        /** @description API version mismatch */
        412: {
